...
Namespace AdvancedInputBox.Controls
    Public Class BooleanSwitch
        ...
        Public ReadOnly Property Result As AdvancedInputBox.InputBoxElementResult Implements AdvancedInputBox.IAdvancedInputBoxElement.Result
            Get
                Return New AdvancedInputBox.InputBoxElementResult(Input_TB.IsChecked, IsRequired, AdvancedInputBox.InputBoxElementResult.ReturnType.Bool, Tag)
            End Get
        End Property
        ...
        End Sub
        Public Sub New(Name As String, Value As Boolean, _IsRequired As Boolean)
            ' This call is required by the designer.
            InitializeComponent()
